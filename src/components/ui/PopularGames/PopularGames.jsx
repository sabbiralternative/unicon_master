          ...
          <div className="grid grid-rows-2 grid-flow-col gap-y-2 w-max md:w-full gap-x-[6px]">
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/aes_baccarat_classic/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
              ...
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    ...
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/aes_dragontiger/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    ...
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/aes_thai_hi_lo/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/spb_aviator/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/spb_aviator/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/jil_rummy/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/jil_rummy/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/jil_royal_fishing/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/jil_royal_fishing/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/dwg_baccarat_evolution_pairs/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/dwg_baccarat_evolution_pairs/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/evo_speed_baccarat_n/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/evo_speed_baccarat_n/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    ...
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/evo_deal_or_no_deal/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/kng_ludo/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/kng_ludo/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/pgp_snakes_and_ladders_megadice/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/pgp_snakes_and_ladders_megadice/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
            <div className="flex w-[112px] sm:w-[120px] md:w-[130px] flex-col items-center justify-center cursor-pointer transition-all ease-in-out duration-100">
              <div className="w-full bg-transparent flex flex-col transition-all ease-in-out duration-200 relative overflow-hidden rounded-[4px]">
                <div className="w-full h-full">
                  <img
                    src="https://luckmedia.link/rtg_aztec_spins/thumb_3_4_custom.webp?q=65&amp;w=600&amp;px=auto&amp;auto=format"
                    width="200"
                    height="auto"
                    className="w-full h-full object-cover rounded-[4px]"
                    alt="casino-event-image"
                    loading="lazy"
                    title="https://luckmedia.link/rtg_aztec_spins/thumb_3_4_custom.webp"
                  />
                </div>
              </div>
            </div>
