    ...
    >
      ...
      <div className="headerDesktop">
        <div className="headerDesktop-content">
          <div className="headerDesktop-content__logo">
          ...
          <div className="headerDesktop-content__search">
            ...
            <div className="form-row">
              <input
                ...
                style={{background:'white',color:'black',border:'1px solid rgb(221, 221, 221)',borderRadius:'3px'}}
              />
      ...
      <div className="headerDeskNav">
        <div className="headerDeskNav-content">
          <div className="headerDeskNav-content__list">
            <div className="list-item">sportsbook</div>
            <div className="list-item">Cricket</div>
            <div className="list-item">Football</div>
            <div className="list-item">Tennis</div>
